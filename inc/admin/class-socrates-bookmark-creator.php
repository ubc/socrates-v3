...
class Socrates_Bookmark_Creator {
	...
	public function create_bookmark_category_if_not_exists( $category = '' ) {
		...
		if ( term_exists( $category, 'link_category' ) ) {
			return;
		}

		wp_insert_term( $category, 'link_category' );
